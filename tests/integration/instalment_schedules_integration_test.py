...
@responses.activate
def test_instalment_schedules_create():
    fixture = helpers.load_fixture('instalment_schedules')['create']
    helpers.stub_response(fixture)
    response = helpers.client.instalment_schedules.create(*fixture['url_params'])
...
@responses.activate
def test_instalment_schedules_create_new_idempotency_key_for_each_call():
    fixture = helpers.load_fixture('instalment_schedules')['create']
    helpers.stub_response(fixture)
    helpers.client.instalment_schedules.create(*fixture['url_params'])
    helpers.client.instalment_schedules.create(*fixture['url_params'])
...
def test_timeout_instalment_schedules_create_idempotency_conflict():
    create_fixture = helpers.load_fixture('instalment_schedules')['create']
    ...
    with helpers.stub_timeout_then_idempotency_conflict(create_fixture, get_fixture) as rsps:
      response = helpers.client.instalment_schedules.create(*create_fixture['url_params'])
      assert_equal(2, len(rsps.calls))

    assert_is_instance(response, resources.InstalmentSchedule)

@responses.activate
def test_timeout_instalment_schedules_create_retries():
    fixture = helpers.load_fixture('instalment_schedules')['create']
...
def test_502_instalment_schedules_create_retries():
    fixture = helpers.load_fixture('instalment_schedules')['create']
