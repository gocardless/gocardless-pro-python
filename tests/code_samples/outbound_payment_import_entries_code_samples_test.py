...
@responses.activate
def test_outbound_payment_import_entries_list_code_sample():
    # Convert :param placeholders to regex wildcards for flexible matching
    stub_url = '/outbound_payment_import_entries'
    ...
    response_body = { 'outbound_payment_import_entries': [{}], 'meta': { 'cursors': {'after': None, 'before': None}, 'limit': 50 } }
    for _ in range(5):
        responses.add(
            'GET',
            url_pattern,
