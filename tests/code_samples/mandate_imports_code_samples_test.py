...
@responses.activate
def test_mandate_imports_create_code_sample():
    # Convert :param placeholders to regex wildcards for flexible matching
    stub_url = '/mandate_imports'
...
@responses.activate
def test_mandate_imports_get_code_sample():
    # Convert :param placeholders to regex wildcards for flexible matching
    stub_url = '/mandate_imports/:identity'
    url_pattern = re.compile('https://api.gocardless.com' + re.sub(r':[\w]+', r'[^/]+', stub_url))
    # Mock response - repeat multiple times to handle code samples with multiple API calls
    response_body = { 'mandate_imports': {} }
    for _ in range(5):
...
@responses.activate
def test_mandate_imports_submit_code_sample():
    # Convert :param placeholders to regex wildcards for flexible matching
    stub_url = '/mandate_imports/:identity/actions/submit'
    url_pattern = re.compile('https://api.gocardless.com' + re.sub(r':[\w]+', r'[^/]+', stub_url))
    # Mock response - repeat multiple times to handle code samples with multiple API calls
    response_body = { 'mandate_imports': {} }
    for _ in range(5):
...
@responses.activate
def test_mandate_imports_cancel_code_sample():
    # Convert :param placeholders to regex wildcards for flexible matching
    stub_url = '/mandate_imports/:identity/actions/cancel'
    url_pattern = re.compile('https://api.gocardless.com' + re.sub(r':[\w]+', r'[^/]+', stub_url))
    # Mock response - repeat multiple times to handle code samples with multiple API calls
    response_body = { 'mandate_imports': {} }
    for _ in range(5):
