...
@responses.activate
def test_negative_balance_limits_list_code_sample():
    # Convert :param placeholders to regex wildcards for flexible matching
    stub_url = '/negative_balance_limits'
    ...
    response_body = { 'negative_balance_limits': [{}], 'meta': { 'cursors': {'after': None, 'before': None}, 'limit': 50 } }
    for _ in range(5):
        responses.add(
            'GET',
            url_pattern,
